      ...
      <section className="userCard__container" key={currentUser.id}>
              ...
              <div className="userCard2">
                ...
                <div className="userCard__searchList">
                  ...
                  <div>
                  <div>{<> <Button onClick={() => {handleClickSearch(cus[0])}}>1. {cus[0].city},{cus[0].state_code} {cus[0].postal_code}</Button> <IconButton className="deleteSearchButton" onClick={() => {removeSearch(cus[0].id, currentUserId)}}><DeleteForeverIcon fontSize="small"/></IconButton></>}</div>
                  <div>{cus[1] ? <> <Button onClick={() => {handleClickSearch(cus[1])}}>2. {cus[1].city},{cus[1].state_code} {cus[1].postal_code}</Button> <IconButton className="deleteSearchButton" onClick={() => {removeSearch(cus[1].id, currentUserId)}}><DeleteForeverIcon fontSize="small"/></IconButton> </> : ``}</div>
                  <div>{cus[2] ? <> <Button onClick={() => {handleClickSearch(cus[2])}}>3. {cus[2].city},{cus[2].state_code} {cus[2].postal_code}</Button> <IconButton className="deleteSearchButton" onClick={() => {removeSearch(cus[2].id, currentUserId)}}><DeleteForeverIcon fontSize="small"/></IconButton> </> : ``}</div>
                  <div>{cus[3] ? <> <Button onClick={() => {handleClickSearch(cus[3])}}>4. {cus[3].city},{cus[3].state_code} {cus[3].postal_code}</Button> <IconButton className="deleteSearchButton" onClick={() => {removeSearch(cus[3].id, currentUserId)}}><DeleteForeverIcon fontSize="small"/></IconButton> </> : ``}</div>
                  <div>{cus[4] ? <> <Button onClick={() => {handleClickSearch(cus[4])}}>5. {cus[4].city},{cus[4].state_code} {cus[4].postal_code}</Button> <IconButton className="deleteSearchButton" onClick={() => {removeSearch(cus[4].id, currentUserId)}}><DeleteForeverIcon fontSize="small"/></IconButton> </> : ``}</div>
                  </div>}
                </div>
